...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "flex items-center justify-between gap-2 rounded-t-lg border-b-[0.5px] bg-muted/72 px-3 py-2 in-[[data-slot=dialog-popup]:has([data-slot=dialog-panel])]:pb-3 max-sm:pb-2",
        className
      )}
...
function DialogFooter({
  ...
  return (
    <div
      className={cn(
        "flex flex-col-reverse gap-2 rounded-b-lg px-3 sm:flex-row sm:justify-end",
        variant === "default" && "border-t-[0.5px] bg-muted/72 py-2",
        variant === "bare" &&
