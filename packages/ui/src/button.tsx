...
const buttonVariants = cva(
  [
    "group relative inline-flex w-fit items-center justify-center rounded-md outline-none",
    ...
    variants: {
      variant: {
        ...
        omi: cn(
          ...
          "hover:from-sky-600 hover:to-blue-500",
          "active:from-sky-700 active:to-blue-600",
