...
const inputBaseStyles = cn(
  "relative w-full appearance-none rounded-lg bg-ui-bg-field-component-hover text-ui-fg-base placeholder-ui-fg-muted caret-ui-fg-base shadow-borders-base outline-none transition-fg hover:bg-ui-bg-component-hover dark:bg-ui-bg-field-component dark:hover:bg-ui-bg-field-component-hover",
