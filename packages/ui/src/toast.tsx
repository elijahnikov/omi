      ...
      >
        {toasts.map((toast) => {
          ...
          return (
            <Toast.Root
              className={cn(
                "absolute z-[calc(9999-var(--toast-index))] h-(--toast-calc-height) w-full select-none rounded-xl border-[0.5px] bg-ui-bg-component not-dark:bg-clip-padding text-popover-foreground shadow-elevation-tooltip [transition:transform_.5s_cubic-bezier(.22,1,.36,1),opacity_.5s,height_.15s] before:pointer-events-none before:absolute before:inset-0",
