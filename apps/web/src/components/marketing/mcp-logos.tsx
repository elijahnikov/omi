...
export const GoogleDriveLogo = (props: SVGProps<SVGSVGElement>) => (
...
export const GoogleCalendarLogo = (props: SVGProps<SVGSVGElement>) => (
...
interface RasterLogoProps {
  className?: string;
}

/** Pocket — used for CSV bookmark imports in the app. */
export const PocketLogo: ComponentType<RasterLogoProps> = ({ className }) => (
  // biome-ignore lint/performance/noImgElement: bundled import logo asset
  <img
    alt=""
    className={`object-contain${className ? ` ${className}` : ""}`}
    height={20}
    src="/import-logos/pocket.png"
    width={20}
  />
);
